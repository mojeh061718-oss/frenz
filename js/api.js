...
const ClaudeAPI = {
  ...
  _BAND_TEXT: {
    ...
    attraction: {
      low: 'no active interest yet — banter is banter, but a flirt aimed at her gets NO performance: a short unbothered reply that ignores the angle, then the conversation moves on. Quiet non-engagement is the answer; it never needs a wall or a big theatrical laugh. The right register on the right nights, sustained over real time, is how interest STARTS — and the first sign is her responses warming from unbothered to playful, long before any words change',
